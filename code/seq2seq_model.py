...
#              "BasicRNN": tf.contrib.rnn.BasicRNNCell(n_hidden),
...
class Seq2SeqModel(object):
    ...
    def __init__(self, encoder_masks, encoder_inputs_tensor,
        ...
        def seq2seq_f(lstm_inputs, decoder_inputs, seq_length, do_decode):
            ...
            outputs, _, attention_weights_history, attention_contents = embedding_attention_decoder(
            ...
            return outputs, attention_weights_history, attention_contents
        ...
        if forward_only:
            self.output, self.loss, self.attention_weights_history, self.attention_contents = model_with_buckets(
