...
def attention_decoder(decoder_inputs, initial_state, attention_states, cell,
    ...
    with variable_scope.variable_scope(scope or "attention_decoder"):
        ...
        for i, inp in enumerate(decoder_inputs):
            ...
            if i == 0 and initial_state_attention:
                ...
                # MODIFIED ADD START
                attns, attn_weights = attention(state)
                attention_contents_history.append(attns)
                attention_weights_history.append(attn_weights)
                # MODIFIED ADD END
    ...
    # MODIFIED ADD START
    return outputs, state, attention_weights_history, attention_contents_history
    # MODIFIED ADD END
...
def model_with_buckets(encoder_inputs_tensor, decoder_inputs, targets, weights,
    ...
    with ops.name_scope(name, "model_with_buckets", all_inputs):
        with variable_scope.variable_scope(variable_scope.get_variable_scope(), reuse=None):
            ...
            bucket_outputs, attention_weights_history, attention_contents = seq2seq(encoder_inputs[:int(bucket[0])],
    ...
    return bucket_outputs, loss, attention_weights_history, attention_contents
