...
class Model(object):
    ...
    def _bulid_da_model(self, img_data_a, img_data_b,
        ...
        self.similarity_losses = self.sequence_encoder_loss()
    ...
    def sequence_encoder_loss(self):
        """
        the cnn out
        """
    ...
    def _initialize_model(self, parameters):
        ...
        if self.load_model:
            ...
            # word_acc, char_acc = self.test('/home/data/OCR/evaluation_data/icdar03/test_tfrecords',
            #                                print_info=False)
            # print("word_acc:", word_acc, "char_acc:", char_acc)

            word_acc_s, char_acc_s = self.test(
                '/home/data/OCR/IAM/words/standard_split_ok/test_tfrecords',
                selected_num=3e4,
                print_info=True,
                error_file=os.path.join(self.checkpoint_path_a, "error_file_split_ok.txt"))
